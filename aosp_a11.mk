...
PRODUCT_COPY_FILES += \
    device/htc/a11/rootdir/system/etc/libnfc-brcm.conf:system/etc/libnfc-brcm.conf \
    device/htc/a11/rootdir/system/etc/libnfc-nxp.conf:system/etc/libnfc-nxp.conf 
